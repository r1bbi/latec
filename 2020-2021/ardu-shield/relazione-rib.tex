...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{piste.png}
...
\begin{figure}[H]
   \centering
        \includegraphics[scale=0.5]{progetto-ini.pdf}
       \label{prog}
...
\begin{figure}[H]
   \centering
        \includegraphics[scale=0.3]{multisim.pdf}
       \label{multisim}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.7]{Ultiboard.pdf}
        \label{ultiabroad}
